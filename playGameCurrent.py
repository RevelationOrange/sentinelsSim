...
ffstr += " +type destroy +target @areas environment @sections inplay @nquants 2 @quantity opt"
...
rftdstr += " +givetarget @areas playarea hero @nquants H @quantity 1 -action +source self +type draw +target @areas self @quantity 1 opt"
...
cdstr += " @sections char inplay @restrictions or hp @nquants all @quantity 2"
...
ghsstr += " +type damage +target @areas villain environment @sections char inplay @restrictions or hp @nquants all @quantity 2 cold"
...
lhstr += " +source self +type put +target @areas self @sections char @quantity 1 -power ~action +source char"
lhstr += " +type damage +target @areas any @sections char inplay @restrictions or hp @nquants 2 @quantity 3 projectile opt"
...
lhstr += " -effect ~trigger damage taken ~criteria all ~mod 1"
